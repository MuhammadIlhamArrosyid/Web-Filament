  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">Template</h1>
        <!-- Icon Divider-->
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
      <div class="container">
        ...
        <div class="row">
          ...
          <h4 class="text-uppercase mb-4">Selamat Datang</h4>  
          <p>Dum Spiro Spero</p>
          <p>Omnium Rerum Principia Parva Sunt</p>
          <h4 class="text-undercase mb-5"> Fortis Fortuna Adiuvat</h4>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <h4 class="text-uppercase mb-4">{{$_nama}}</h4>
            <p class="lead mb-0">
              {{$_location}}
            </p>
          </div>
